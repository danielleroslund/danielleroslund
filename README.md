...
Right now I'm building a small suite of systems projects (database, cache, web server, React) to strengthen my understanding of how the tools I use actually work under the hood.
